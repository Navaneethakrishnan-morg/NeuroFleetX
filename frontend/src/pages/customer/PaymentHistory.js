                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3 text-sm text-white/50">
                        ...
                        <span className={`font-semibold ${
                          booking.status === 'IN_PROGRESS' ? 'text-accent-green' : 'text-accent-cyan'
                        }`}>
                          {booking.status}
                        </span>
                      </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${
                      payment.status === 'CANCELLED' ? 'from-red-500 to-red-600' : 'from-accent-green to-accent-cyan'
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-right">
                      <p className={`text-2xl font-bold ${
                        payment.status === 'CANCELLED' ? 'text-red-400 line-through' : 'text-accent-green'
                      }`}>
                        ${(payment.totalPrice || 0).toFixed(2)}
                      </p>
                      <span className={`status-badge ${
                        payment.status === 'CANCELLED' ? 'status-critical' : 'status-available'
                      } text-xs`}>
